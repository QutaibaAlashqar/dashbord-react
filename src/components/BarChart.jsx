  ...
  return (
    <ResponsiveBar
      ...
      axisBottom={{ tickSize: 5, tickPadding: 5, tickRotation: 0,
        ...
        legendPosition: "middle", legendOffset: 32
      }}
      ...
      legends={[{ dataFrom: "keys", anchor: "bottom-right", direction: "column", justify: false, translateX: 120, translateY: 0, itemsSpacing: 2, itemWidth: 100, 
